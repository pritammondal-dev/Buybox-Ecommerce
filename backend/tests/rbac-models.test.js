...
describe("Phase 1B.1 — Dynamic RBAC/PBAC Foundation", () => {
  ...
  describe("9. RBAC Seeding Idempotency", () => {
    it("seeds all 49 permissions and 6 system roles idempotently", async () => {
      // First seed run
      const result1 = await seedRbac();
      expect(result1.permissionsSeeded).toBe(49);
      ...
      expect(result2.permissionsSeeded).toBe(49);
